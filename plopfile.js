...
module.exports = function(plop) {
  ...
  plop.setGenerator("shared-component", {
    ...
    actions: [
      ...
      {
        type: "add",
        path: "src/shared/components/{{properCase componentName}}/{{properCase componentName}}.spec.ts",
        templateFile: "templates/component/component.spec.ts.hbs"
      },
      {
        type: "add",
        path:
          "src/shared/components/{{properCase componentName}}/{{properCase componentName}}.stories.ts",
        templateFile: "templates/component/component.stories.ts.hbs"
      },
      {
        type: "add",
        path: "src/shared/components/{{properCase componentName}}/{{properCase componentName}}.vue",
