...
export default class VueSlider extends Vue {
  ...
  get progressWidth(): string {
    if (this.isMultiRange) {
      return `${parseInt(this.handleRightPosition, 10) -
  ...
  refresh() {
    this.sliderBox = (this.$refs
      .slider as HTMLDivElement).getBoundingClientRect();
  }
