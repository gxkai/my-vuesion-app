<template>
  <div>
    ...
    >
      ...
      <p>
        Create components, VueX connected components, modules - and their tests
        - right from the CLI!
      </p>
      <br />
      ...
      <p>
        ...
        of thought! Your saved changes to the CSS and TypeScript are reflected
        instantaneously without refreshing the page or restarting your server.
        Preserve application state even when you update something in the
        underlying code!
      </p>
      <br />
      <vue-headline level="3">Tons of use-cases</vue-headline>
      <p>
        e.g. HttpService with interceptors, vuex persist middleware, redirect
        scenarios, configs for different environments, etc.
      </p>
    </home-section>
    ...
    >
      ...
      <p>
        We support SEO (document head tags management) and server-side-rendering
        for search engines that support indexing of JavaScript content. (eg.
        Google)
      </p>
      <br />
      <vue-headline level="3">Best practices</vue-headline>
      <p>
        A Common style guide, TypeScript, and the best test setup: Automatically
        guarantee code quality and non-breaking changes.
      </p>
      <br />
      <vue-headline level="3">i18n</vue-headline>
      <p>
        Scalable apps need to support multiple languages, easily add and support
        multiple languages with vue-i18n.
      </p>
    </home-section>
    ...
    >
      ...
      <p>
        Offline-first support with service-workers and a lighthouse score as
        high as possible (90+).
      </p>
      <br />
      <vue-headline level="3">Design System</vue-headline>
      <p>
        Includes a blueprint for a 100% customizable Design System with a huge
        amount of
      ...
      <ol>
        <li>
          Download or clone (<code
            >git clone https://github.com/<br />vuesion/vuesion</code
          >) the repository
        </li>
...
import HomeSection from "@/views/home/components/HomeSection/HomeSection.vue";
...
@Component({
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: "og:image:url",
        content: "https://vuesion.herokuapp.com/logo.png"
      },
...
export default class Home extends Vue {
  get disableParticles() {
    return AppModule.config?.features?.disableParticles ?? false;
  }
}
</script>
